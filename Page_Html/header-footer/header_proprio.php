...
<header>
    <a href="../Accueil/Tableau_de_bord.php">
        ...
        <div class="imghead">
<<<<<<< HEAD
            <a onclick="openPopup('popup', 'overlay_profil-deconnexion')"><img id="pp" class="imgprofilP" src="../Ressources/Images/<?php echo $photo['photo']; ?>" width="50" height="50"></a>
=======
...
>>>>>>> 16a0fef31be7aa8570cae99eebe7d0029f220d3e
        </div>
        </div>
