        ...
        <?php
           ...
           ?>
            <div class="logpc">
                ...
                <div class="detailimg">
                    <img class="photoprincipal" src="../Ressources/Images/<?php echo $info['photo_principale'];?> ">
                    <div class="photosec">
                        <?php
                        for ($i = 0 ; $i < 2; $i++){
                            if (isset($photos_secondaires[$i]['photo'])){
                                ?><img class="photosecondaire" src="../Ressources/Images/<?php echo $photos_secondaires[$i]['photo']?>"><?php
                            }
                        }?>
                         <?php for ($i = 2 ; $i < 6 ; $i++){
                            if (isset($photos_secondaires[$i]['photo'])){
                                ?><img class="photosecondaire2" src="../Ressources/Images/<?php echo $photos_secondaires[$i]['photo']?>"><?php
                            }
                        }?>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="logrow">
                    <div class="cardcondition">
                        <h4 class="policetitreh4">Conditions d'annulation</h4>
                    ...
                    <div class="cardcondition">
                        <h4 class="policetitreh4">Conditions de paiement</h4>
                        <p>Culpa officia magna sit duis cillum laborum. Et labore fugiat ad ullamco excepteur nisi commodo nisi cupidatat nulla. Esse eu fugiat id veniam ipsum et dolor sint ullamco incididunt quis irure nulla. Mollit exercitation officia pariatur velit ullamco. Pariatur ipsum proident proident consectetur magna proident tempor ex commodo officia.
                        </p>
                    </div>
                </div>
                <div class="logrow">
                <div class="cardcondition">
                    <h4 class="policetitreh4">Informations d'arrivée</h4>
                    <p>Culpa officia magna sit duis cillum laborum. Et labore fugiat ad ullamco excepteur nisi commodo nisi cupidatat nulla. Esse eu fugiat id veniam ipsum et dolor sint ullamco incididunt quis irure nulla. Mollit exercitation officia pariatur velit ullamco. Pariatur ipsum proident proident consectetur magna proident tempor ex commodo officia.
                    </p>
                </div>

                <div class="cardcondition">
                    <h4 class="policetitreh4">Informations de départ</h4>
                    <p>Culpa officia magna sit duis cillum laborum. Et labore fugiat ad ullamco excepteur nisi commodo nisi cupidatat nulla. Esse eu fugiat id veniam ipsum et dolor sint ullamco incididunt quis irure nulla. Mollit exercitation officia pariatur velit ullamco. Pariatur ipsum proident proident consectetur magna proident tempor ex commodo officia.
                    </p>
                </div>
            </div>
