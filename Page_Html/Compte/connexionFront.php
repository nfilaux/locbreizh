    ...
    <main class="container offset-md-2 col-8">
        <form action="connexionBack.php" method="post">
            <div class="form-group mt-2">
                <input type="text" id="pseudo" style="font-size: 2em;" name="pseudo" class=" offset-md-2 col-8 text-center custom-input mb-5" placeholder="Identifiant" value="<?php if (isset($_GET['pseudo'])) {
                                                                                                                                                                                    echo htmlentities($_GET['pseudo']);
                                                                                                                                                                                } ?>" />
                <?php
                erreur("pseudo");
                ?>
